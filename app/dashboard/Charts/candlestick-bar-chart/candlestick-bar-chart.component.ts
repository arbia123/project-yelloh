...
@Component({
  selector: 'app-candlestick-bar-chart',
  templateUrl: './candlestick-bar-chart.component.html',
  styleUrls: ['../../../../../node_modules/nvd3/build/nv.d3.min.css'],
  encapsulation: ViewEncapsulation.None

})
export class CandlestickBarChartComponent implements OnInit {
  ...
  ngOnInit() {
    this.setCandlestickChartOptions();
    this.fetchData();
  }

  setCandlestickChartOptions() {
    this.options = {
      chart: {
